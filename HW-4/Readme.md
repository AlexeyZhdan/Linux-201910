...
Для того чтобы перемонтировать файловую систему используется команда ***mount -o remount,rw /*** проверить что система смонтировалась в режиме **RW** можно изменив любой файл или используя команду ***mount | grep root***
...
![alt text](./media/Scrinshots/2-nd-start-en.jpg)
